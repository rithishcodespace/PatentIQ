      ...
      {evidence && evidence.text ? (
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            {/* Legal Excerpt Box */}
            <div className="rounded-xl border border-slate-200/80 border-l-4 border-l-indigo-600 bg-slate-50/70 p-5 relative overflow-hidden transition-all">
              <div className="pl-1">
