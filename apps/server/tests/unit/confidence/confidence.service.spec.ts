...
import type { NoveltyAnalysisResult } from '../../../src/modules/rag/interfaces/rag.interface.js';
...
describe('ConfidenceService Unit Tests', () => {
  ...
  const mockNoveltyAnalysis: NoveltyAnalysisResult = {
