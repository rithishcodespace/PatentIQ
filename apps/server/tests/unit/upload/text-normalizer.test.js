...
1. An adjustable bracket comprising a swivel hinge and locking pin.`;
    ...
    describe('fromDirectText', () => {
        it('should produce standardized output object from direct text input', () => {
            const result = TextNormalizer.fromDirectText(' Wireless Drone ', ' Resonant inductive charging. ', ' 1. A drone receiver. ', ['wireless', 'DRONE']);
            ...
            expect(result.fullText).toBe('Title: Wireless Drone\n\nAbstract:\nResonant inductive charging.\n\nClaims:\n1. A drone receiver.\n\nKeywords: wireless, DRONE');
        });
    });
});
//# sourceMappingURL=text-normalizer.test.js.map