...
export class RagService {
    searchService;
    llmProvider;
    noveltyAnalysisService;
    overlapAnalysisService;
    featureDeconstructionService;
    confidenceService;
    cacheProvider;
    constructor(searchService, llmProvider, noveltyAnalysisService, overlapAnalysisService, featureDeconstructionService, historyService, confidenceService, cacheProvider) {
    ...
    async analyze(request) {
        ...
        const confidence = this.confidenceService.computeFullConfidence(results, noveltyResponse.analysis, topK, overlappingClaimsCount);
        const metrics = {
            retrievalTimeMs,
     ...
     */
    async rerankCrossEncoder(candidates, topK = 10) {
