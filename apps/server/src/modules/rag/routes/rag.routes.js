import { SearchRequestSchema, RagAnalysisResponseSchema, standardErrorResponses, } from '../../../common/schemas/swagger.schemas.js';
export async function ragRoutes(fastify, controller) {
    ...
    fastify.post('/analyze', {
        schema: {
            ...
            description: 'Retrieves Top-K prior-art candidates and prompts Qwen LLM via Ollama to generate a 7-section novelty report, section/claim overlaps, risk classification, and patentability recommendations. Automatically checks for and reuses existing cached analyses to save compute costs.',
        ...
        handler: (req, reply) => controller.analyze(req, reply),
    });
    ...
    fastify.post('/deconstruct', {
        ...
        handler: (req, reply) => controller.deconstruct(req, reply),
    });
    ...
    fastify.post('/rank', {
        ...
        handler: (req, reply) => controller.rank(req, reply),
    });
    ...
    fastify.post('/design-around', {
        schema: {
            ...
            description: 'Generates actionable engineering modifications, conflict explanations, and estimated patentability novelty boosts when prior-art overlap is identified.',
            response: {
                400: standardErrorResponses[400],
                500: standardErrorResponses[500],
            },
        },
        handler: (req, reply) => controller.designAround(req, reply),
    });
}
