...
Please evaluate the element-level overlap matrix and output JSON conforming strictly to this structure:
{
  ...
  "matrix": [
    ...
    static parseLLMResponse(llmOutput, features, patents) {
    ...
    static normalizeRiskLevel(raw, score) {
...
//# sourceMappingURL=novelty-matrix.prompt.js.map