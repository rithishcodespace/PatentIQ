...
export async function usersRoutes(fastify, controller) {
    ...
    fastify.get('/:id', {
        ...
        handler: (req, reply) => controller.getProfile(req, reply),
    });
    ...
    fastify.put('/:id', {
        ...
        handler: (req, reply) => controller.updateProfile(req, reply),
    });
    ...
    fastify.delete('/:id', {
        ...
        handler: (req, reply) => controller.deleteProfile(req, reply),
    });
}
