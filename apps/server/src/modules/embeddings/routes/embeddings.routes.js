...
export async function embeddingsRoutes(fastify, controller) {
    ...
    fastify.post('/generate', {
        ...
        handler: (req, reply) => controller.generate(req, reply),
    });
    ...
    fastify.post('/batch', {
        ...
        handler: (req, reply) => controller.generateBatch(req, reply),
    });
}
