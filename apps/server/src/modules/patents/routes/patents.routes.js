...
export async function patentsRoutes(fastify, controller) {
    ...
    fastify.post('/ingestion/run', {
        ...
        handler: (req, reply) => controller.triggerIngestionPipeline(req, reply),
    });
    ...
    fastify.post('/ingestion/schedule', {
        ...
        handler: (req, reply) => controller.configureIngestionSchedule(req, reply),
    });
...
//# sourceMappingURL=patents.routes.js.map