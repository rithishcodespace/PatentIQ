...
export class IngestionPipelineService {
    ...
    constructor(prisma, parserService, embeddingProvider, vectorStoreProvider) {
     ...
     */
    async triggerPipelineRun(options = {}) {
        if (this.isRunning) {
            ...
            try {
                ...
                for (let i = 0; i < rawFiles.length; i += batchSize) {
                    ...
                    for (const filePath of batchFiles) {
                        ...
                        this.statusState.progressPercent = Math.round(((this.statusState.processedCount + this.statusState.errorCount) / rawFiles.length) * 100);
                    }
                }
                this.statusState.status = 'completed';
                this.statusState.stage = 'idle';
     ...
     */
    configureSchedule(intervalMinutes, enabled) {
...
//# sourceMappingURL=ingestion-pipeline.service.js.map