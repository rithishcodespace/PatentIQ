...
export class PatentParserService {
     ...
     */
    extractStructuredPatentSection(cleanedText, metadataTitle) {
     ...
     */
    splitIntoClaimsArray(claimsBlock) {
        if (!claimsBlock)
            return [];
...
//# sourceMappingURL=patent-parser.service.js.map