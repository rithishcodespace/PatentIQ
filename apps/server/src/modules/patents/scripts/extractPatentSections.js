...
export class PatentSectionExtractor {
     ...
     */
    async extractDatasetSections(options) {
        ...
        try {
            for await (const rawRow of parser) {
                totalProcessed++;
                const extractedPatent = PatentSectionExtractor.extractSections(rawRow);
                ...
                if (totalProcessed % logInterval === 0) {
                    ...
                    Logger.info(`Extracted ${totalProcessed.toLocaleString()} patents | ` +
                        `Heap: ${heapMB} MB | ` +
...
//# sourceMappingURL=extractPatentSections.js.map