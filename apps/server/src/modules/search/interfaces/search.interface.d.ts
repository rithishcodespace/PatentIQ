...
export interface ISearchService {
     ...
     */
    executeSearch(query: string, topK?: number, filters?: SearchFilter): Promise<{
        results: SearchResult[];
...
export interface ISearchRepository {
    querySimilarity(vector: number[], topK: number, filter?: Record<string, any>): Promise<PineconeMatchResult[]>;
}
