import { BenchmarkRequestDtoSchema } from '../dto/benchmark.dto.js';
...
export class BenchmarkController {
    ...
    async benchmark(request, reply) {
        ...
        request.log.info(`[BenchmarkAPI] totalRuns=${report.summary.queries} | avgLatency=${report.summary.averageLatency}ms | P95=${report.summary.p95Latency}ms | throughput=${report.summary.throughput} req/s`);
