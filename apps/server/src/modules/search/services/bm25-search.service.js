export class BM25SearchService {
    ...
    tokenize(text) {
        ...
        const rawWords = text
            ...
            .filter((w) => w.length > 1);
        const tokens = [];
        const technicalBoostMap = new Map();
     ...
     */
    rankDocuments(query, documents, topK = 50) {
        ...
        const scoredDocs = docTokenizations.map(({ doc, tokens, length }) => {
...
//# sourceMappingURL=bm25-search.service.js.map