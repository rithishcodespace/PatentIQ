import { HistoryListResponseSchema, HistoryRecordSchema, standardErrorResponses, } from '../../../common/schemas/swagger.schemas.js';
export async function historyRoutes(fastify, historyController) {
    // GET /api/history - Paginated search history listing with filtering & sorting
    fastify.get('/', {
        schema: {
            tags: ['History'],
            summary: 'List Search History & Novelty Analyses',
            description: 'Retrieves paginated search history records from PostgreSQL database supporting query string filtering, date range bounds, IPC classification, and sorting.',
            querystring: {
                type: 'object',
                properties: {
    ...
    fastify.get('/:id', {
        schema: {
            ...
            description: 'Retrieves full details of a specific search history entry including retrieved patents and generated novelty analysis report.',
            params: {
                type: 'object',
                required: ['id'],
                properties: {
    ...
    fastify.delete('/:id', {
        schema: {
            ...
            description: 'Deletes a search history entry by ID. Cascades deletion to associated retrieved patent matches and novelty analysis reports.',
            params: {
                type: 'object',
                required: ['id'],
                properties: {
